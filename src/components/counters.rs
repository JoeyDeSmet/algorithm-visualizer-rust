...
pub fn Counters(cx: Scope) -> impl IntoView {
  ...
  view! { cx,
    <>
      ...
      <button class="btn btn-success" on:click=add_counter>
        "Add Counter"
      </button>

      <button class="btn btn-danger" on:click=add_many_counters>
        {format!("Add {MANY_COUNTERS} Counters")}
      </button>

      <button class="btn btn-primary" on:click=clear_counters>
        "Clear"
      </button>
